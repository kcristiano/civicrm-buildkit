...
pushd "$WEB_ROOT/web/wp-content/plugins" >> /dev/null
  ...
  git clone ${CACHE_DIR}/gutenberg/civicrm-gutenberg-blocks.git         -b master          civicrm-gutenberg-blocks
  git clone ${CACHE_DIR}/dhc/disable-health-check.git         -b master          disable-health-check
